...
public class GCMPushReceiverService extends FirebaseMessagingService {
   ...
   /* @Override
    ...
    private void sendNotif2(){
        ...
        Intent ii = new Intent(getApplicationContext(), PostsActivity.class);
      ...
      /*  Intent intent = new Intent(this, Login_activity.class);
       ...
       // PendingIntent pendingIntent = PendingIntent.getActivity(this, requestCode, intent, PendingIntent.FLAG_ONE_SHOT);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            noBuilder.setSmallIcon(R.drawable.newlogo);
            noBuilder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.newlogo));
        } else {
            noBuilder.setSmallIcon(R.drawable.newlogo);
        }
